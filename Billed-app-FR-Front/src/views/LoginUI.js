      ...
      <div class="page-div">
        <div class="row">
          <div class="title-container"> 
            ...
            <h2> Billed </h2> <!-- Utilisation de la balise h2 ici -->
          </div>
        </div>
        <div class="row">
          <div class="col-sm-6">
            <div class="card">
              <div class="card-body">
                <form class="form-signin" data-testid="form-employee">
                  <h2 class="h3 mb-3 font-weight-normal">Employé</h2> <!-- Utilisation de la balise h2 ici -->
            ...
            <div class="card">
              <div class="card-body">
                <form class="form-signin" data-testid="form-admin">
                  <h2 class="h3 mb-3 font-weight-normal">Administration</h2> <!-- Utilisation de la balise h2 ici -->
                  <label for="inputEmail">Votre email</label>
